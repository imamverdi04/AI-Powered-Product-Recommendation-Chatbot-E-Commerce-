# ============================================================
#   AI Recommendation Chatbot — Google Colab + Gemini
...
def build_prompt(query, top_products, history, summary, vector_mem):
    ...
    return f"""Sən BirMarket-in AI məhsul assistantısan. Azərbaycan dilində cavab ver.
...
def chat():
    print("=" * 55)
    print("  BirMarket AI Məhsul Tövsiyə Chatbotu")
